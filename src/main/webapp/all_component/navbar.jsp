<div class="container-fluid" style="height: 10px; background-color: #9575cd"></div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<i class="fa-solid fa-book-open-reader"></i> Latest Books</a></li>
			
			<li class="nav-item active"><a class="nav-link" href="#">
			<i class="fa-solid fa-book-open-reader"></i> New Books</a></li>
			
			<li class="nav-item active"><a class="nav-link disabled" href="#">
			<i class="fa-solid fa-book-open-reader"></i> Old Books</a>
			</li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			...
			<i class="fa-solid fa-phone-volume"></i> Contact Us</button>
		</form>
	</div>
</nav>